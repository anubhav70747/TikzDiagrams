...
\draw[rounded corners,color=green,ultra thick]  (4,3.5) rectangle (8,-2);
...
\draw[rounded corners,color=blue,ultra thick]  (13,3.5) rectangle (17,-2);
...
\node (v32) at (7,1.5) {};
\node (v33) at (14,1.5) {};
\draw [-triangle 60,line width=4pt]  (v32) edge node[above]{\huge $\rho_{a_0,a_1,e,E}$} (v33);
