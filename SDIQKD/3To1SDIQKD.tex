...
\node (v19) at (-2,1.5) {};
\draw[rounded corners,color=red,ultra thick]  (-5,3.5) rectangle (-1,-2);
\draw[rounded corners,color=blue,ultra thick]  (4,3.5) rectangle (8,-2);
...
\node (v20) at (5,1.5) {};
\draw [-triangle 60,line width=4pt] (v19) edge node[above]{\huge $\rho_{a_0,a_1,a_2}\in \mathcal{H}_2$} (v20);
